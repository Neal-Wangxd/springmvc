...
<script type="text/javascript">
	function userAdd(){
		...
		form.action="/springmvc-review-ssm/user/addUser";
		form.method="post";
		form.submit();
	}
</script>
		...
		<form action="">
			<table>
				...
				<tr>
					...
					<td>
						<input type="number" name="hight" value="${errorMsgList.hightMsg != null ? '' :userInfo.hight}" placeholder="输入正确的身高"><small>${errorMsgList.hightMsg}</small>
					</td>
				</tr>
				<tr>
					<td>
				...
				<tr>
					<td><input type="button" value="提交" onclick="userAdd()"></td>
